...
const translations = {
  en: {
    ...
    manual_ship_carrier: 'Carrier (5 sectors)',
    manual_ship_battleship: 'Battleship (4 sectors)',
    manual_ship_cruiser: 'Cruiser (3 sectors)',
    manual_ship_submarine: 'Submarine (3 sectors)',
    manual_ship_destroyer: 'Destroyer (2 sectors)',
  ...
  vi: {
    ...
    how_to_play_desc: 'Tìm hiểu các kiến thức cơ bản về hải chiến và làm chủ chiến trường.',
    how_to_play_video: 'Video Hướng Dẫn',
    
    // Detailed Manual
    manual_overview_title: 'Tổng Quan Trò Chơi',
    manual_overview_desc: 'Battleship là trò chơi đối kháng 2 người, nơi mỗi người chỉ huy một hạm đội và cố gắng đánh chìm toàn bộ tàu của đối thủ trước.',
    manual_components_title: 'Khí Tài Chiến Thuật',
    manual_ocean_grid: 'Lưới Đại Dương: Nơi đặt hạm đội của bạn.',
    manual_target_grid: 'Lưới Mục Tiêu: Theo dõi tọa độ hạm đội địch.',
    manual_peg_red: 'Chốt Đỏ: Xác nhận bắn trúng mục tiêu.',
    manual_peg_white: 'Chốt Trắng: Bắn trượt, trúng mặt nước.',
    
    manual_fleet_title: 'Cơ Cấu Hạm Đội',
    manual_fleet_desc: 'Mỗi người chơi sở hữu 5 con tàu đặc chủng với kích thước khác nhau:',
    manual_ship_carrier: 'Giá đỡ: 5 ô',
    manual_ship_battleship: 'Thiết giáp hạm: 4 ô',
    manual_ship_cruiser: 'Tàu tuần dương: 3 ô',
    manual_ship_submarine: 'Tàu ngầm: 3 ô',
    manual_ship_destroyer: 'Khu trục hạm: 2 ô',
    
    manual_placement_title: 'Giai Đoạn Dàn Trận',
    manual_placement_desc: 'Trước khi bắt đầu, mỗi người chơi bí mật sắp xếp tàu của mình trong khu vực tác chiến.',
    manual_placement_rules_title: 'Luật Đặt Tàu:',
    manual_rule_1: 'Chỉ được đặt ngang hoặc dọc.',
    manual_rule_2: 'Không được đặt theo đường chéo.',
    manual_rule_3: 'Tàu phải nằm hoàn toàn trong lưới 10x10.',
    manual_rule_4: 'Các tàu không được đè lên nhau.',
    manual_rule_5: 'Có thể đặt các tàu sát cạnh nhau.',
    manual_rule_6: 'Vị trí tàu không được thay đổi khi trận đánh bắt đầu.',
    
    manual_gameplay_title: 'Gameplay Cơ Bản',
    manual_gameplay_desc: 'Hai người chơi lần lượt tấn công nhau bằng cách gọi tọa độ trên lưới (ví dụ: A5, C7).',
    manual_turn_process: 'Quy trình lượt: Chọn tọa độ mục tiêu -> Quan sát kết quả -> Đánh dấu bản đồ.',
    
    manual_sinking_title: 'Tiêu Diệt Tàu',
    manual_sinking_desc: 'Khi mọi ô của một tàu đều bị trúng đạn, tàu đó bị đánh chìm. Theo truyền thống, bạn phải thông báo: "Bạn đã đánh chìm chiến hạm của tôi!"',
    
    manual_victory_title: 'Điều Kiện Chiến Thắng',
    manual_victory_desc: 'Người chơi đầu tiên đánh chìm toàn bộ 5 hạm đội của đối phương sẽ giành chiến thắng.',
    
    step_1: 'GIAI ĐOẠN 1: DÀN TRẬN',
    step_1_desc: 'Triển khai hạm đội trên lưới chiến thuật 10x10. Hãy tính toán kỹ để tránh bị địch phát hiện.',
    step_2: 'GIAI ĐOẠN 2: TÁC CHIẾN',
    step_2_desc: 'Tấn công tọa độ địch. Mỗi lượt 1 phát. Trúng mục tiêu sẽ được tặng thêm lượt bắn.',
    step_3: 'GIAI ĐOẠN 3: TIÊU DIỆT',
    step_3_desc: 'Tiêu diệt toàn bộ chiến hạm của quân địch để giành chiến thắng cuối cùng.',
    ...
    pve_training: 'Ghost AI (PVE)',
    ready_to_deploy: 'SẴN SÀNG XUẤT KÍCH',
