  ...
  return (
    <AnimatePresence>
      {showTurnNotify && (
        ...
        >
          <div className="bg-primary/20 backdrop-blur-xl border-y border-primary/40 w-full py-12 flex flex-col items-center gap-4 relative overflow-hidden">
      ...
      {gameStatus === 'waiting' && (
        <motion.div 
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[120] flex items-center justify-center bg-[#060912]/95 backdrop-blur-md"
        >
      ...
      {gameResult && (
        <motion.div 
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="fixed inset-0 z-[110] flex items-center justify-center bg-[#060912]/90 backdrop-blur-md p-6"
        >
          <motion.div 
          ...
          >
            ...
            <div className="flex flex-col w-full gap-3">
              ...
              <button
                ...
                className="w-full py-4 bg-slate-800 text-slate-400 rounded-xl font-black uppercase tracking-widest hover:bg-slate-700 hover:text-white transition-all border border-white/5"
              >
                {t('exit_to_lobby')}
              </button>
            </div>
